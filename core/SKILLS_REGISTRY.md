...
| 22 | [`raspberry-pi-management`](.agents/skills/raspberry-pi-management/SKILL.md) | Sentry node (Pi 3A+), Local DNS Sinkhole API caching, Tailscale fallback. | SSH, Paramiko, Local DNS Sinkhole API |
...
| 37 | [`homelab-mesh-dns-governor`](.agents/skills/homelab-mesh-dns-governor/SKILL.md) | **[AUTO-SYNTHESIZED]** Autonomous sentinel monitoring Tailscale peers, Pi-hole DNS blocking, SSH tunnels, and local cluster health across ComputeNode and sentry nodes. | Autonomous Evolution Engine, System 2 Sentinel |
